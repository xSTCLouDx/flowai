...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Morning meditation' }),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], CreateHabitDto.prototype, "name", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ required: false, example: '10 minutes of mindfulness' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], CreateHabitDto.prototype, "description", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ enum: ['daily', 'weekly', 'custom'], example: 'daily' }),
    (0, class_validator_1.IsEnum)(['daily', 'weekly', 'custom']),
    __metadata("design:type", String)
